...
const Contact:React.FC<any> = () => {
    return (
        ...
        <form className="flex flex-col font-serif px-2 lg:w-[600px] mx-auto mb-32">
            <input className="border-solid border-gray-400 border-[1px] border-b-0 p-2 focus:outline-none" type="text" placeholder="Enter your name"/>
            <input className="border-solid border-gray-400 border-[1px] border-b-0 p-2 focus:outline-none" type="email" placeholder="Enter your email"/>
            <input className="border-solid border-gray-400 border-[1px] border-b-0 p-2 focus:outline-none" type="text" placeholder="Subject" />
